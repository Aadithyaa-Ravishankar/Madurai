                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.category, color: Color(0xFFDC2626), size: 20),
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.calendar_today, size: 20, color: Color(0xFFDC2626)),
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    color: _selectedDate == null ? Colors.grey[600] : const Color(0xFF1F2937),
                                    fontSize: 16,
                                  ),
                                ),
                              ],
                              ...
                              child: TextFormField(
                                ...
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return l10n.selectLocationOnMap;
                                  }
                                  return null;
                                },
                                decoration: InputDecoration(
                        ...
                        if (_detectedWardNo != null)
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                l10n.wardNo(_detectedWardNo.toString()),
                                style: const TextStyle(
                                  color: Colors.green,
                                  fontWeight: FontWeight.w600,
                                  fontSize: 14,
