    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Column(
            children: [
              _buildInfoRow(Icons.phone, 'Phone', _userProfile?['phone'] ?? 'Not set'),
              const Divider(height: 1),
              _buildInfoRow(
                Icons.location_on,
                'Address',
                _userProfile?['address'] ?? 'Not set',
                subtitle: _detectedWardNo != null ? 'Ward No: $_detectedWardNo' : null,
              ),
            ],
          ),
        ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text('Address', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.grey[700])),
              ...
              if (_detectedWardNo != null)
                Padding(
                  ...
                  child: Text(
                    'Detected Ward No: $_detectedWardNo',
